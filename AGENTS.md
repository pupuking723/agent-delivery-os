...
Use Codex as the orchestration layer for the full delivery workflow:
...
- Design handoff: Figma via `Codex-figma`
- Development: Codex, local shell, `opencli`, `docker`
...
- Use `Codex-figma` to pull structure, copy, components, spacing, and implementation hints from Figma.
...
- Figma design extraction, use `Codex-figma`
